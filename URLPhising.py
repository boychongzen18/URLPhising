...
#   Facebok : https://web.facebook.com/xroot.xroot.7
#   By Boychonzen aka Xroot
##########################################################################
...
def banner():
    print('''\033[1m\033[93m[\033[91m!\033[93m] Tools Priv8 URL_Phising \n \033[1;37m
	Welcombek My Tools \n \033[1;31m
   ____ _____________.____             __________.__    .__       .__                
|    |   \______   \    |            \______   \  |__ |__| _____|__| ____    ____  
|    |   /|       _/    |      ______ |     ___/  |  \|  |/  ___/  |/    \  / ___\ 
|    |  / |    |   \    |___  /_____/ |    |   |   Y  \  |\___ \|  |   |  \/ /_/  >
|______/  |____|_  /_______ \         |____|   |___|  /__/____  >__|___|  /\___  / 
                 \/        \/                       \/        \/        \//_____/   v2.0
\033[1;36mAuthor \033[35m:\033[37m Boychongzen aka Xroot \n \033[1;33m
\033[1;30mEksekusi \033[35m:\033[37m python URLPhising.py facebook.com				 
''')
...
if __name__ == "__main__":
    banner()
    parser = argparse.ArgumentParser(usage="URLPhising.py {domain} [options]", description="Command line version of URLPhising")
    parser.add_argument("domain", help="Domain name with termination (example.com)")
    parser.add_argument("-cE", dest="check", action="store_true", help="Check if url is URLPhising (won't generate URLPhising)")
